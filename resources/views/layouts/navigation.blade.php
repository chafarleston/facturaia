            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6 sm:space-x-8">
                    ...
                    <div class="relative" id="comprobante-menu">
                        ...
                        <div id="comprobante-dropdown" class="hidden absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="mt-2">
                            @csrf
                            <button type="submit" class="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                {{ __('Log Out') }}
                            </button>
                        </form>
                    </x-slot>
